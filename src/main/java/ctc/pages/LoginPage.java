...
public class LoginPage extends AbstractPage {
    private String ADDITIONAL_URL = "/login.do?logout=true&tz=GMT%2B06:00";
    private By USER_NAME_INPUT_LOCATOR = By.xpath("//input[@name='username']");
    private By PASSWORD_INPUT_LOCATOR = By.xpath("//input[@name='password']");
    private By LOGIN_BUTTON_LOCATOR = By.xpath("//input[@name='Login']");
    private By LOGIN_PAGE_TEXT_LOCATOR = By.xpath("//td[@class='header1']/h1");
